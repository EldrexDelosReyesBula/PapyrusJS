...
🚧 Please use "CairnJS" (https://cairnjs.vercel.app) for new projects and future development.

Papyr.js remains available for existing projects and historical reference, but no further feature development is planned here.»
...
«For new projects: Papyr.js is deprecated. Please use "CairnJS" (https://cairnjs.vercel.app) instead.»
...
Papyr.js has reached the end of its experimental development phase.

The project is now deprecated and will remain available primarily for:

- Existing projects
- Historical reference
- Documentation
- Experimentation with the original Papyr architecture

Future development has moved to CairnJS.

👉 "Visit CairnJS" (https://cairnjs.vercel.app)
